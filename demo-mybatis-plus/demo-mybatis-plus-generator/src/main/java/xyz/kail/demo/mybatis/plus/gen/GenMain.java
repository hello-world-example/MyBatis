package xyz.kail.demo.mybatis.plus.gen;
...
import static xyz.kail.demo.mybatis.plus.gen.InputTool.scanner;
...
//        tableConfig.setNameConvert(new NameConvert());
    ...
    private static PackageConfig newPackageConfig() {
        ...
        packageConfig.setParent("xyz.kail.demo.mybatis.plus.gen.mapper");
